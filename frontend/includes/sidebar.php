...
<div class="card p-4 mb-4 sticky-top" style="top: 90px;" data-aos="fade-left">
    ...
    <?php foreach ($recentPosts as $post): ?>
        <a href="<?= BASE_URL . 'blog/' . $post['slug']; ?>" class="recent-post-item">
            <img 
                src="<?= !empty($post['featured_image']) ? htmlspecialchars($post['featured_image']) : 'https://picsum.photos/seed/' . $post['id'] . '/200'; ?>" 
