                                    ...
                                    <table class="table align-items-center table-flush" id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $blog['category_name'] ?? 'N/A' ?></td>

                                                <td><img src="<?php echo BASE_URL . $blog['featured_image']; ?>" alt="<?php echo $blog['title']; ?>" width="150" height="80"></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo BASE_URL; ?>admin/blog/delete?id=<?php echo (int) $blog['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this data?');">
